...
#'
#' @description Fit the Hurdle Generalized Lambda Distribution to a dataset by numerical maximum likelihood.
#'
#' @details Given a dataset, estimate by the numerical maximum likelihood method the five parameters of the HGLD.
#' Fit both the RS and the FMKL parametrizations. Also fit mixture of HGLD.
#'
